    ...
    return (
      <section className="latest-info">
        ...
        <article className="latest-info__news">
          <h3>Coronavirus: algunas provincias ya permiten el "paseo recreativo"</h3>
          <p className="latest-info__paragraph">Se trata de la nueva medida para permitirles a los argentinos el poder salir del confinamiento, al
          ...
          <img className="latest-info__image" src="./img/viernes-de-coronavirus-20200320-928863.jpg" alt="Se permite el paseo recreativo"/>
        </article>
        <aside className="latest-info__aside">
          <h3 className = "latest-info__weather--title">Pronóstico para hoy: </h3>
          <img className="latest-info__weather" src="./img/widget-clima-realista_1284-4092.jpg" alt="El clima de hoy"/>
          <h3 className="latest-info__dolar--title">Dólar hoy:</h3>
